    ...
    return (
        <div className="flex text-white">
            ...
            >
                ...
                <nav className="mt-10">
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/dashboard">
                    ...
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/ui-elements">
                        <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/tables">
                        <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/forms">
                    ...
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/cards">
                    ...
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/modal">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <a className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4" to="/blank">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
