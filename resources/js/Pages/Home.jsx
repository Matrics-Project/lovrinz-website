    ...
    {books.map((book) => (
      ...
      >
        ...
        <div className="p-4 text-center">
          ...
          <p className="text-sm text-blue-500 mb-4">{book.category}</p>
          <p className="text-sm text-gray-500 mb-4">{book.description}</p>

          <a href={`/books/${book.id}`} className="px-4 py-3 bg-blue-500 text-white rounded hover:bg-blue-600">Detail</a>
        </div>
      </div>
    ))}
  </div>
